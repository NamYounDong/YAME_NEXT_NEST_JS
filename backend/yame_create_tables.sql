...
ALTER TABLE SOURCE_PAGE
	ADD COLUMN IF NOT EXISTS FETCH_DONE TINYINT(1) NOT NULL DEFAULT 0 COMMENT '원문 페치 완료 여부',
	ADD COLUMN IF NOT EXISTS PARSE_DONE TINYINT(1) NOT NULL DEFAULT 0 COMMENT '파싱 완료 여부',
	ADD COLUMN IF NOT EXISTS NORMALIZE_DONE TINYINT(1) NOT NULL DEFAULT 0 COMMENT '증상 정규화 완료 여부',
	ADD COLUMN IF NOT EXISTS EMBED_DONE TINYINT(1) NOT NULL DEFAULT 0 COMMENT '임베딩 캐시 완료 여부',
	ADD COLUMN IF NOT EXISTS LAST_ERROR TEXT NULL COMMENT '마지막 오류 메세지',
	ADD COLUMN IF NOT EXISTS UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
CREATE INDEX IF NOT EXISTS IDX_SOURCE_PAGE_STATUS ON SOURCE_PAGE (FETCH_DONE, PARSE_DONE, NORMALIZE_DONE, EMBED_DONE);  
...
/* ===========================================
  SOURCE_PAGE_DISEASE: 원문 페이지 ↔ 질병 연결(선택사항) 제거
=========================================== */
drop table SOURCE_PAGE_DISEASE;
...
CREATE TABLE IF NOT EXISTS DISEASE_MASTER (
	...
	DISEASE_NAME_KOR VARCHAR(200) NOT NULL,
	DISEASE_NAME_ENG VARCHAR(200) NULL,
	DESCRIPTION LONGTEXT NULL,
	SYMPTOMS_RAW LONGTEXT NULL COMMENT '파서 추정 원문 증상(쉼표/불릿 구분)',
	SOURCE ENUM('AMC','WIKIPEDIA','OTHER') NOT NULL,
	SOURCE_URL TEXT NOT NULL,
	SOURCE_PAGE_ID BIGINT NULL,
	CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	UNIQUE KEY UK_DISEASE_NAME_SRC (DISEASE_NAME_KOR, SOURCE),
	KEY IDX_DISEASE_NAME_KOR (DISEASE_NAME_KOR),
	CONSTRAINT FK_DISEASE_TO_PAGE FOREIGN KEY (SOURCE_PAGE_ID)
